...
<body>
<!-- รูปเลื่อนหัวข้อ -->
<div class="parallax-section parallax-fx about-3 parallaxOffset no-padding" style="background-image: url(<?php echo base_url()?>assets/fontend/images/show/promotion_show.jpg); ">
    <div class="w100 ">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="parallax-content clearfix  wow fadeInUp" data-wow-duration=".8s" data-wow-delay="0">
                        <h2 class="intro-heading ">โปรโมชั่นช่วงนี้ ของ
                            <br> Puttapisake.com
                        </h2>
                    </div>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="about-content wow fadeIn" data-wow-duration=".8s" data-wow-delay="0">
                <p class="lead-2 text-center">
                    ท่านสามารถติดตามข่าวสารการจัดโปรโมชั่น ลดราคา ของทางเว็บไซต์ได้จากส่วนนี้
                </p>
            </div>
            <?php foreach($data_promotion as $key => $pro) {
                if ($key % 2 == 1) {
                    ?>
                    ...
                    <div class="row has-equal-height-child">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xxs-12 is-equal">
                            <div class="content-inner wow fadeInLeft" data-wow-duration=".8s" data-wow-delay="0">
                                <img src="<?php echo base_url('assets/pic_promotion/' . $pro['promotion_Picture']); ?>"
