        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-home"></i> <span>FRONT</span></a>
                </div>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel2"><center>กรุณาเข้าสู่ระบบ</center></h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="<?php echo base_url()?>index.php/user/login" method="post">
                                                <div>
                                                    <label>ชื่อผู้ใช้</label>
                                                    <input type="text" class="form-control" placeholder="Username" required="" id="user_Username" name="user_Username">
                                                    <br/>
                                                </div>
                                                <div>
                                                ...
                                                <div class="separator">
                                                    ...
                                                    <a class="reset_pass" href="#">ลืมรหัสผ่าน?</a>
                                                    <br/>
                                                </div>
                                            </form>
                                        </div>
