...
<div class="navbar navbar-tshop navbar-fixed-top megamenu" role="navigation">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand " href="index.html"> <img src="<?php echo base_url()?>assets/fontend/images/logo.png" alt="TSHOP"> </a>
                        ...
                        <li class="megamenu-content ">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="<?php echo base_url()?>assets/fontend/images/site/promo1.jpg" alt="product"> <span
                                            class="ProductMenuCaption"> <i class="fa fa-caret-right"> </i> JEANS </span>
                                    </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="<?php echo base_url()?>assets/fontend/images/site/promo2.jpg" alt="product"> <span
                                            class="ProductMenuCaption"> <i
                                                class="fa fa-caret-right"> </i> PARTY DRESS </span> </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="<?php echo base_url()?>assets/fontend/images/site/promo3.jpg" alt="product"> <span
                        ...
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem "><a href="product-details.html"> <img
                                            class="img-responsive" src="<?php echo base_url()?>assets/fontend/images/site/g4.jpg" alt="img"> </a> <a
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem relative"><a href="product-details.html"> <img
                                            class="img-responsive" src="<?php echo base_url()?>assets/fontend/images/site/g5.jpg" alt="img"> </a> <a
                                        class="text-center productInfo alpha90" href="product-details.html"> Eodem modo
                                        typi <br>
                                        <span> $60 </span> </a></li>
                            </ul>
                    ...
                    <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                        <div class="w100 miniCartTable scroll-pane">
                            <table>
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/3.jpg" alt="img">
                                            </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/2.jpg" alt="img">
                                            </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/5.jpg" alt="img">
                                            </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/4.jpg" alt="img">
                                            </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/site/winter.jpg"
                                                                                  alt="img"> </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
    ...
    <div class="full-container">
        <div class="slider-content">
            ...
            <div class="slider slider-v1"
                ...
                <div class="slider-item slider-item-img1"><img src="<?php echo base_url()?>assets/fontend/images/slider/slider0.jpg"
                ...
                <div class="slider-item slider-item-img1">
                    ...
                    <img src="<?php echo base_url()?>assets/fontend/images/slider/slider1.jpg" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                ...
                <div class="slider-item slider-item-img2 ">
                    ...
                    <img src="<?php echo base_url()?>assets/fontend/images/slider/slider3.jpg" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                ...
                <div class="slider-item slider-item-img3 ">
                    ...
                    <img src="<?php echo base_url()?>assets/fontend/images/slider/slider4.jpg" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                ...
                <div class="slider-item slider-item-img3">
                    <div class="sliderInfo">
                        <div class="container">
                            <div class="col-lg-5 col-md-6 col-sm-5 col-xs-5 pull-left sliderText blankstyle transformRight">
                                <div class="inner text-right"><img src="<?php echo base_url()?>assets/fontend/images/slider/color.png" class="img-responsive"
                                                                   alt="img"></div>
                            </div>
                    ...
                    <img src="<?php echo base_url()?>assets/fontend/images/slider/6.jpg" class="img-responsive parallaximg sliderImg" alt="img"></div>
            </div>
            <!--/.slider slider-v1-->
        </div>
        <!--/.slider-content-->
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/34.jpg" alt="img"
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/30.jpg" alt="img"
                                                            class="img-responsive"></a>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/36.jpg" alt="img"
                                                            class="img-responsive"></a>
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/9.jpg" alt="img" class="img-responsive"></a>
                    </div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/12.jpg" alt="img"
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/13.jpg" alt="img"
                                                            class="img-responsive"></a></div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/21.jpg" alt="img"
                                                            class="img-responsive"></a></div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/24.jpg" alt="img"
                                                            class="img-responsive"></a></div>
                    <div class="description">
            ...
            <div class="item">
                <div class="product">
                    ...
                    <div class="image">
                        ...
                        <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/15.jpg" alt="img"
                                                            class="img-responsive"></a></div>
                    <div class="description">
...
<div class="container main-container">
                            ...
                            <div id="carousel-id-1" class="carousel slide" data-ride="carousel" data-interval="0">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active"><a href="product-details.html"> <img
                                                src="<?php echo base_url()?>assets/fontend/images/product/5.jpg" alt="img" class="img-responsive "></a></div>
                                    <div class="item"><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/21.jpg"
                                                                                           alt="img"
                                                                                           class="img-responsive "></a>
                                    </div>
                                    <div class="item"><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/30.jpg"
                                                                                           alt="img"
                                                                                           class="img-responsive "></a>
                                    </div>
                                </div>
                    ...
                    <div class="product">
                        ...
                        <div class="imageHover">
                            ...
                            <div id="carousel-id-2" class="carousel slide carousel-fade" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active"><a href="product-details.html"> <img
                                                src="<?php echo base_url()?>assets/fontend/images/product/22.jpg" alt="img" class="img-responsive "></a></div>
                                    <div class="item"><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/5.jpg"
                                                                                           alt="img"
                                                                                           class="img-responsive "></a>
                                    </div>
                                    <div class="item"><a href="product-details.html"> <img src="<?php echo base_url()?>assets/fontend/images/product/18.jpg"
                                                                                           alt="img"
                                                                                           class="img-responsive "></a>
                                    </div>
                                </div>
                    ...
                    <div class="product">
                        ...
                        <div class="imageHover">
                            <a href="product-details.html">
                                <img src="<?php echo base_url()?>assets/fontend/images/product/12.jpg" alt="img" class="img-responsive primaryImage">
                                <img src="<?php echo base_url()?>assets/fontend/images/product/21.jpg" alt="img" class="img-responsive secondaryImage"></a>
                ...
                <div class="item itemauto  col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="imageHover imageHoverFlip">
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/7.jpg" alt="img"
                                                                class="img-responsive primaryImage">
                                <img src="<?php echo base_url()?>assets/fontend/images/product/13.jpg" alt="img" class="img-responsive secondaryImage"></a>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/31.jpg" alt="img"
                                                                class="img-responsive"></a>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/33.jpg" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/10.jpg" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
                            <h4><a href="product-details.html">sequitur mutationem </a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/37.jpg" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
                            <h4><a href="product-details.html">consuetudium lectorum.</a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/35.jpg" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
                            <h4><a href="product-details.html">parum claram</a></h4>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/14.jpg" alt="img"
                                                                class="img-responsive"></a>
                ...
                <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="<?php echo base_url()?>assets/fontend/images/product/17.jpg" alt="img"
                                                                class="img-responsive"></a>
    ...
    <div class="width100 section-block ">
        <div class="row featureImg">
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="category.html"><img src="<?php echo base_url()?>assets/fontend/images/site/new-collection-1.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="category.html"><img src="<?php echo base_url()?>assets/fontend/images/site/new-collection-2.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="category.html"><img src="<?php echo base_url()?>assets/fontend/images/site/new-collection-3.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="category.html"><img src="<?php echo base_url()?>assets/fontend/images/site/new-collection-4.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="no-margin brand-carousel owl-carousel owl-theme">
                    <li><a><img src="<?php echo base_url()?>assets/fontend/images/brand/1.gif" alt="img"></a></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/2.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/3.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/4.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/5.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/6.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/7.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/8.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/1.gif" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/2.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/3.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/4.png" alt="img"></li>
                    <li><img src="<?php echo base_url()?>assets/fontend/images/brand/5.png" alt="img"></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <div class="pull-right paymentMethodImg"><img height="30" class="pull-right"
                                                          src="<?php echo base_url()?>assets/fontend/images/site/payment/master_card.png" alt="img"> <img
                    height="30" class="pull-right" src="<?php echo base_url()?>assets/fontend/images/site/payment/visa_card.png" alt="img"><img height="30"
                                                                                                          class="pull-right"
                                                                                                          src="<?php echo base_url()?>assets/fontend/images/site/payment/paypal.png"
                                                                                                          alt="img">
                <img height="30" class="pull-right" src="<?php echo base_url()?>assets/fontend/images/site/payment/american_express_card.png" alt="img"> <img
                    height="30" class="pull-right" src="<?php echo base_url()?>assets/fontend/images/site/payment/discover_network_card.png" alt="img">
                <img height="30" class="pull-right" src="<?php echo base_url()?>assets/fontend/images/site/payment/google_wallet.png" alt="img">
