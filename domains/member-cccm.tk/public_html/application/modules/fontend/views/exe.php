    ...
    <div class="slider-content">
        ...
        <div class="slider slider-v1"
            ...
            <div class="slider-item slider-item-img1">
                <img src="<?php echo base_url()?>assets/fontend/images/slider/slider0.jpg" class="img-responsive parallaximg sliderImg" alt="img">
            </div>
            <div class="slider-item slider-item-img1">
                    ...
                    <div class="container">
                        <div class="col-lg-12 col-md-12 col-sm-12 sliderTextFull ">
                            <div class="inner text-center">
                                ...
                                <a class="btn btn-danger btn-lg bottomAnima animated opacity0">SHOP NOW ON Puttapisake.com
                    ...
                    <div class="container">
                        <div class="col-lg-12 col-md-12 col-sm-12 sliderTextFull  ">
                            <div class="inner dark maxwidth500 text-center animated topAnima">
                                ...
                                <a class="btn btn-danger btn-lg">SHOP NOW ON Puttapisake.com <span
