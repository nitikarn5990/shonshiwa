...
class F_model extends CI_Model {
    ...
    public function get_data_offers() {
    ...
    public function get_data_philosophy() {

        $this->db->select('*');
        $this->db->from('tbl_philosophy');
        $this->db->where('id', 1);
    ...
    public function get_data_treatment() {
    ...
    public function get_data_gallery($group = 'photo') {
    ...
    public function get_data_slides() {
    ...
    public function get_data_footer() {
