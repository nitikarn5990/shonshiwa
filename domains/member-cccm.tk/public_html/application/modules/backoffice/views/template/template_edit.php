                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-wrench"></i> จัดการสินค้า <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="product_type.html">จัดการประเภทสินค้า</a></li>
                                    <li><a href="product_group.html">จัดการกลุ่มสินค้า</a></li>
                                    <li><a href="product.html">จัดการรายการสินค้า</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-wrench"></i> จัดการข่าวสาร <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="promotion.html">จัดการโปรโมชั่น</a></li>
                                    <li><a href="portfolio.html">จัดการผลงาน</a></li>
                                </ul>
                            </li>
                            <li><a href="member.html">จัดการสมาชิก</a></li>
                            <li><a><i class="fa fa-wrench"></i> จัดการรายงานสินค้า </a></li>
                        </ul>
                    </div>
                </div>
                <!-- /sidebar menu -->
