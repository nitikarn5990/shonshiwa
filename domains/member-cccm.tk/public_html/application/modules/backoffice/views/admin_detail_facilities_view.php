...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>จัดการรายละเอียด Facilities</h2>
        ...
        <div class="x_content">
            ...
            <br />
            <form class="form-horizontal form-label-left" id="tinyMCEForm"  onsubmit="return detailValidate()" method="post"  action="<?= base_url()?>backoffice/Admin/edit_facilities" enctype="multipart/form-data">
                
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">หัวข้อ (Eng) <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="gallery_title[en]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data1 = unserialize($data[0]['gallery_title']);  echo $data1['en'];?> ">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="gallery_title[nl]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data2 = unserialize($data[0]['gallery_title']);  echo $data2['nl'];?>">
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">รายละเอียด Facilities (Eng)<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="gallery_detail[en]" id="gallery_detail1" placeholder="กรุณากรอกข้อมูล" ><?php $data3 = unserialize($data[0]['gallery_detail']); echo $data3['en']; ?></textarea>
                    </div>
                </div>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">รายละเอียด Facilities (Netherland)<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="gallery_detail[nl]" id="gallery_detail2" placeholder="กรุณากรอกข้อมูล" ><?php $data4 = unserialize($data[0]['gallery_detail']); echo $data4['nl']; ?></textarea>
                    </div>
                </div>
