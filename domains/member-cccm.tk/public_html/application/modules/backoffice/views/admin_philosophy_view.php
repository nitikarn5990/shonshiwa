...
<!--<div class="x_content ">
    ...
    <div class="">
        ...
        <button type="button" class="btn btn-round btn-success pull-left" data-toggle="modal" data-target=".bs-example-modal-sm2"><i class="fa fa-edit"></i> คลิกแก้ไข philosophy</button>
    </div>
       <p>&nbsp;</p>
