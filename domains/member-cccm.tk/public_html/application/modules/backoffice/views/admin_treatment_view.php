...
<!--<div class="x_content ">
    ...
    <div class="">
        ...
        <button type="button" class="btn btn-round btn-success pull-left" data-toggle="modal" data-target=".bs-example-modal-sm2"><i class="fa fa-edit"></i> คลิกแก้ไข treatment</button>
    </div>
       <p>&nbsp;</p>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <br />
            <form class="form-horizontal form-label-left" id="tinyMCEForm"  onsubmit="return detailValidate()" method="post"  action="<?= base_url() ?>backoffice/Admin/edit_treatment" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="treatment_title[en]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data1 = unserialize($data_treatment[0]['treatment_title']);
            echo $data1['en'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="treatment_title[nl]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data2 = unserialize($data_treatment[0]['treatment_title']);
            echo $data2['nl'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="treatment_detail[en]" id="treatment_detail1" placeholder="กรุณากรอกข้อมูล" ><?php $data3 = unserialize($data_treatment[0]['treatment_detail']);
            echo $data3['en'] ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="treatment_detail[nl]" id="treatment_detail2" placeholder="กรุณากรอกข้อมูล" ><?php $data4 = unserialize($data_treatment[0]['treatment_detail']);
