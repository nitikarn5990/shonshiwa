...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <br />
            <form class="form-horizontal form-label-left" id="tinyMCEForm"  onsubmit="return detailValidate()" method="post"  action="<?= base_url()?>backoffice/Admin/edit_contact" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id" value="<?=$id?>">
                   <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="contact_title[en]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data1 = unserialize($data_contact[0]['contact_title']);
            echo $data1['en']
            ?>">
                    </div>
                </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" required=""  name="contact_title[nl]" id="" placeholder="กรุณากรอกข้อมูล" value="<?php $data2 = unserialize($data_contact[0]['contact_title']);
            echo $data2['nl']
            ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="contact_detail[en]" id="contact_detail1" placeholder="กรุณากรอกข้อมูล" ><?php $data3 = @unserialize($data_contact[0]['contact_detail']); echo $data3['en']; ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control tinymce" rows="3" name="contact_detail[nl]" id="contact_detail2" placeholder="กรุณากรอกข้อมูล" ><?php $data4 = @unserialize($data_contact[0]['contact_detail']); echo $data4['nl']; ?></textarea>
                    </div>
                </div>
