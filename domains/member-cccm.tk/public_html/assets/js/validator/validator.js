...
var validator = (function($){
	...
	*/
	//message = {
	//	invalid			: 'กรุณากรอกข้อมูลให้ครบ',
	//	empty			: 'กรุณาใส่ข้อมูล',
	//	min				: 'กรอกรหัสน้อยเกินไป',
	//	max				: 'กรอกรหัสมากเกินไป',
	//	number_min		: 'too low',
	//	number_max		: 'too high',
	//	url				: 'invalid URL',
	//	number			: 'ไม่ใช่ตัวเลข',
	...
	*/
	...
	function checkAll( $form )
	{
		...
		fieldsToCheck.each(function(){
			if( typeof($(this).attr('data-input-label')) != 'undefined' || $(this).attr('data-input-label')!='')
			{
				validator.message['empty'] = 'กรุณากรอกข้อมูล ' + $(this).attr('data-input-label');
			}

			// use an AND operation, so if any of the fields returns 'false' then the submitted result will be also FALSE
			submit = submit * validator.checkField.apply(this);
		});
